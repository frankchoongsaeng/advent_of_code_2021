...
public class MainPartTwo {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        keep a count of how many boards have won
        as soon as boards won equals totalBoards,
        get the last winning board
        */
        Vector[] lastWinningBoard = new Vector[5];
        boolean foundWinningBoard;
        int numberMarker = 0;
        int sliceSize = 5;
        int totalBoardCount = allboards.size();
        ArrayList<Vector[]> totalBoardsWon = new ArrayList<>();
        ...
        while (true) {
            ...
            for (Vector[] b : allboardsCopy) {
                ...
                if (foundWinningBoard) {
                    lastWinningBoard = b;
                    if (!totalBoardsWon.contains(b)) totalBoardsWon.add(b);
                    if (totalBoardCount == totalBoardsWon.size()) break outside;
                }
        ...
        printOneBoard(lastWinningBoard);
        ...
        print the result
         */
        int unmarkedTotal = addUnmarkedNumbers(lastWinningBoard);
